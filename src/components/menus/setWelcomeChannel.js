...
export const customID = 'chooseWelcomeChannel'
...
export default async interaction => {
	...
	if (updateData && updateData.Channel === selectedChannelId) {
		const embedExists = createEmbed(
			colors.warning,
			locale('components.menus.welcomeChannelSelect.channelAlreadySet'),
		)
	...
	const embedSuccess = createEmbed(
		colors.success,
		locale('components.menus.welcomeChannelSelect.channelSet', {
